...
| `reprox_proxy_tls_handshakes_total`            | counter | `result=success\|failure`                                                  | Proxy-path TLS handshake outcomes.                                                                                                                                                                                             |
| `reprox_fallback_tls_handshakes_total`         | counter | `result=success\|failure`                                                  | Fallback-path TLS handshake outcomes.                                                                                                                                                                                          |
| `reprox_fallback_alpn_selected_total`          | counter | `protocol=h2\|http1\|none`                                                 | Negotiated ALPN protocol on the fallback path.                                                                                                                                                                                 |
